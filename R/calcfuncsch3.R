...
problistch3[[4]] <- function(SULT, age, tt, kk, rr, ss, ww, FAA, ansbox = TRUE) # ${_{t+s}p_{x+r}},$ ($s, t$ and/or $r$ may be 0), UDD / CF
{
  ...
  } else
  {
    ...
    s.ans <- paste0(s.tpx(age + rr, tt + ss),"=", s.ans1.fac1, s.ans1.fac2, s.ans1.fac3,"\\overset{CF}{=}", s.ans2.fac1, s.ans2.fac2, s.ans2.fac3, "=", s.ans3.fac1, s.ans3.fac2, s.ans3.fac3, "=", fbox(tpx, ansbox))
  }
  return(list(s.prob=s.prob, s.ans=s.ans, num.ans=tpx))  
}
